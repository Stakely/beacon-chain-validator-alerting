...
const importPublicKeys = async (depositFile) => {
...
// Usage: node src/import_deposits.js deposits/<deposit file>
if (process.argv[2]) {
  importPublicKeys(process.argv[2])
} else {
  console.error('Example usage: node src/import_deposits.js deposits/deposit_data-xxx.json')
}
